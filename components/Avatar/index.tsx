...
const Avatar = () => {
  ...
  const imgBorder = useColorModeValue({border: "5px solid", borderRadius:'50%', borderColor:'black'}, {border: "5px solid", borderRadius:'50%', borderColor:'#9DECF9'})
